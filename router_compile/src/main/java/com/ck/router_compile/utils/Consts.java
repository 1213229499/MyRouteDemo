package com.ck.router_compile.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("com.ck.router_core", "DNRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.ck.router_annotation.Route";
    public static final String ANN_TYPE_Extra = "com.ck.router_annotation.Extra";


    public static final String IROUTE_GROUP = "com.ck.router_core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.ck.router_core.template.IRouteRoot";
    public static final String IEXTRA = "com.ck.router_core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.ck.router_core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.ck.router_routes";
